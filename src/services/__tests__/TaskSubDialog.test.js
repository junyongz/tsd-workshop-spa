...
test('with existing tasks', async () => {
    ...
    const TaskSubDialogWrapper = () => {
        const [tasks, setTasks] = useState([
                {id: 8800001, quotedPrice: 150, recordedDate: "2022-02-02", remarks: undefined, subsystem: 'Parking Brake',
                ...
                {id: 8800002, quotedPrice: 50, recordedDate: "2022-02-02", remarks: "sew it nicely", subsystem: 'cab', 
